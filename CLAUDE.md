...
Hyperscript-LSP is a Language Server Protocol implementation for
[hyperscript](https://hyperscript.org), providing intelligent code assistance
through autocompletion, hover documentation, validation, and more.
...
[docs/dev/development-workflow.md](docs/dev/development-workflow.md).

## Technical Details

### Language Elements

The project uses a data-driven approach with five primary hyperscript language
elements stored in SQLite:
