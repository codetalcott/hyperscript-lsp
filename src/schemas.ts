...
const KeywordDefinitionSchema = GrammarElementBaseSchema.extend({
  ...
  usage_context: z.array(z.string()).default([]).describe("Array of usage context examples for this keyword."),
  syntax_examples: z.array(z.string()).default([]).describe("Array of syntax examples showing the keyword in use."),
...
const SpecialSymbolDefinitionSchema = GrammarElementBaseSchema.extend({
  ...
  symbol: z.string().describe("The actual symbol (e.g., 'me', 'it', '@')."),
  ...
  usage_context: z.array(z.string()).default([]).describe("Array of usage context examples for this symbol."),
  syntax_examples: z.array(z.string()).default([]).describe("Array of syntax examples showing the symbol in use."),
